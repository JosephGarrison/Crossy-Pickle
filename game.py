...
#------------------------Images---------------------
        ...
        self.enemies = [
            Enemy(0, 600, 50, 50, 'assets/enemy.png', 2),
            Enemy(750, 400, 50, 50, 'assets/enemy.png', 2),
            Enemy(0, 200, 50, 50, 'assets/enemy.png', 2), 
        ]
        ...
        while True:
            ...
            for event in events:
                if event.type == pygame.QUIT:
                    return
                elif event.type == pygame.KEYDOWN: #Move player
                    if event.key == pygame.K_UP:
                        player_direction = -1
                    elif event.key == pygame.K_DOWN:
                        player_direction = 1
                elif event.type == pygame.KEYUP: #Stop player from continuously moving
